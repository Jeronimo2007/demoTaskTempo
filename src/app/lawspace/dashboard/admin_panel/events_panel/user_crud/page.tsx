...
const UserCrudPage: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'salary',
      className: 'text-black',
      render: (salary: number) => `$${salary.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
    },
    {
      title: 'Costo',
      dataIndex: 'cost',
      key: 'cost',
      className: 'text-black',
      render: (cost: number) => `$${cost.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
    },
    {
    ...
    },
    {
      ...
      key: 'weekly_hours',
      className: 'text-black',
      render: (hours: number) => `${hours.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}h`,
    },
    {
      title: 'Desvinculado',
